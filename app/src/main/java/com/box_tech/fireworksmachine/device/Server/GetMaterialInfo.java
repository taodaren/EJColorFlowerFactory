...
public class GetMaterialInfo {
    private interface OnFinished extends GeneralRequest.OnFinished<Result> {}

    private static class Request extends GeneralRequest<Result>{
        public Request(long material_id, Activity activity, GetMaterialInfo.OnFinished callback){
            super(activity, callback);
            setUrl(Settings.SERVER_URL + "materialInfo");
            addField("material_id", material_id);
        }
    }
