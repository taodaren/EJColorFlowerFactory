...
public class RegisterActivity extends AppCompatActivity {
    ...
    static void start_me(Context context, String phoneNumber){
    ...
    private void onFailed(@NonNull String message){
        showProgress(false);
        Toast.makeText(this, String.format(Locale.CHINA, getString(R.string.error_register_failed), message), Toast.LENGTH_SHORT).show();
    }
}
